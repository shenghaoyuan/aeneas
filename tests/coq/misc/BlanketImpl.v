...
Definition trait2_foo_default : result unit :=
  Ok tt.

(** [blanket_impl::{blanket_impl::Trait2 for T}::foo]:
    Source: 'tests/src/blanket_impl.rs', lines 9:0-9:31 *)
Definition trait2_Blanket_foo (trait1Inst : Trait1_t T) : result unit :=
  Ok tt.

(** Trait implementation: [blanket_impl::{blanket_impl::Trait2 for T}]
    Source: 'tests/src/blanket_impl.rs', lines 9:0-9:31 *)
Definition Trait2_Blanket (trait1Inst : Trait1_t T) : Trait2_t T := {|
