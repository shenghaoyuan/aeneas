...
let boolTrait_ret_true_default (self1 : self) : result bool =
  Ok true
...
let boolTraitOption_get_bool (self : option t) : result bool =
...
let boolTraitOption_ret_true (self : option t) : result bool =
  Ok true

(** Trait implementation: [traits::{traits::BoolTrait for core::option::Option<T>}]
    Source: 'tests/src/traits.rs', lines 24:0-31:1 *)
let boolTraitOption : boolTrait_t (option t) = {
...
let test_bool_trait_option (x : option t) : result bool =
...
let test_bool_trait (boolTraitInst : boolTrait_t t) (x : t) : result bool =
  boolTraitInst.get_bool x

(** Trait declaration: [traits::ToU64]
    Source: 'tests/src/traits.rs', lines 41:0-43:1 *)
noeq type toU64_t = { to_u64 : self -> result u64; }
...
let toU64Pair_to_u64 (toU64Inst : toU64_t a) (self : (a & a)) : result u64 =
  let (x, x1) = self in
...
let toU64traitsWrapper (toU64Inst : toU64_t t) : toU64_t (wrapper_t t) = {
...
let h2 (toU64Inst : toU64_t t) (x : wrapper_t t) : result u64 =
  toU64traitsWrapper_to_u64 toU64Inst x

(** Trait declaration: [traits::ToType]
    Source: 'tests/src/traits.rs', lines 90:0-92:1 *)
noeq type toType_t = { to_type : self -> result t; }
...
noeq type ofType_t = {
  of_type : (toTypeInst : toType_t t self) -> t -> result self;
}
...
noeq type testType_test_TestTrait_t = { test : self -> result bool; }
...
let toTypetraitsBoolWrapperT (toTypeBoolTInst : toType_t bool t) : toType_t
  boolWrapper_t t = {
...
let test_where1 (_x : t) : result unit =
  Ok ()

(** [traits::test_where2]:
    Source: 'tests/src/traits.rs', lines 196:0-196:60 *)
let test_where2
  (withConstTyTU32Clause1_W32Inst : withConstTy_t t u32 clause1_w 32)
  (_x : u32) :
  result unit
  =
  Ok ()
...
let test_child_trait1
  (childTraitInst : childTrait_t t clause1_clause1_w) (x : t) : result string =
...
noeq type childTrait1_t = { parentTrait1Inst : parentTrait1_t self; }
...
noeq type cFnOnce_t = { call_once : self -> args -> result self_output; }
...
noeq type getTrait_t = { get_w : self -> result self_w; }
...
noeq type trait_t = { cLEN : usize; }

(** [traits::{traits::Trait for @Array<T, N>}::LEN]
    Source: 'tests/src/traits.rs', lines 317:4-317:25 *)
let trait_array_len_body : result usize = Ok n
let trait_array_len : usize = eval_global (trait_array_len_body t n)

(** Trait implementation: [traits::{traits::Trait for @Array<T, N>}]
    Source: 'tests/src/traits.rs', lines 316:0-318:1 *)
let traitArray : trait_t (array t n) = { cLEN = trait_array_len t n; }

(** [traits::{traits::Trait for traits::Wrapper<T>}::LEN]
    Source: 'tests/src/traits.rs', lines 321:4-321:25 *)
let traittraits_wrapper_len_body (traitInst : trait_t t) : result usize = Ok 0
let traittraits_wrapper_len (traitInst : trait_t t) : usize =
...
let traittraitsWrapper (traitInst : trait_t t) : trait_t (wrapper_t t) = {
  cLEN = traittraits_wrapper_len traitInst;
}

(** [traits::use_wrapper_len]:
    Source: 'tests/src/traits.rs', lines 324:0-326:1 *)
let use_wrapper_len (traitInst : trait_t t) : result usize =
...
let foo_foo_body (traitInst : trait_t t)
  : result (core_result_Result_t t i32) =
  Ok (Core_result_Result_Err 0)
let foo_foo (traitInst : trait_t t) : core_result_Result_t t i32 =
  eval_global (foo_foo_body u traitInst)

(** [traits::use_foo1]:
    Source: 'tests/src/traits.rs', lines 337:0-339:1 *)
let use_foo1 (traitInst : trait_t t) : result (core_result_Result_t t i32) =
  Ok (foo_foo u traitInst)

(** [traits::use_foo2]:
    Source: 'tests/src/traits.rs', lines 341:0-343:1 *)
let use_foo2 (traitInst : trait_t u) : result (core_result_Result_t u i32) =
